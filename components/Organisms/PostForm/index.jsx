            ...
            <MantineProvider 
                ...
                <form onSubmit = {(e)=> handleCheckSubmission(e)}>
                    <FlexBox align ="stretch">
                        ...
                        <Spacer axis="vertical" size={25}/>
                        <MaxTextArea onChange={(e) => setContent(e.target.value)}   borderBottom = "2px solid #C2ADff" boxShadow = "0 0 2px 2px #38004d" name = "content" rows = "15" id = "content" text = {content}  label = "Story" placeholder = "Enter your queery" maxLength = "5000" />
                        <Spacer axis="vertical" size={25}/>
                        <Breakline/>
                        <Spacer axis="vertical" size={25}/>
                        <FlexBox>
